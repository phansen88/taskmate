    ...
    <div>
      <Transition.Root show={sidebarOpen} as={Fragment}>
        ...
        >
          ...
          >
            <div className="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-orchid-700">
              <Transition.Child
                as={Fragment}
                  ...
                  {navigation.map((item) => (
                    <NavLink
                      ...
                      className={({ isActive }) =>
                        classNames(
                          isActive
                            ? 'bg-orchid-600 text-white underline'
                    ...
                    >
                      <DynamicHeroIcon
                        icon={item.icon}
                        iconstyles="mr-4 flex-shrink-0 h-6 w-6 text-orchid-300"
                      />
                      {item.title}
                    </NavLink>
                  ))}
      ...
      <div className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
        ...
        <div className="flex flex-col flex-grow pt-5 bg-orchid-700 overflow-y-auto">
                    ...
                    >
                      <DynamicHeroIcon
                        ...
                        iconstyles={`mr-3 flex-shrink-0 h-6 w-6 ${
                          item.current
                            ? 'text-orchid-300'
                            : 'text-orchid-300 group-hover:text-orchid-400'
                        }`}
                      />
                    ...
                    {({ open }) => (
                      <>
                        ...
                        >
                          <DynamicHeroIcon
                            icon={item.icon}
                            iconstyles="mr-3 flex-shrink-0 h-6 w-6 text-orchid-300 group-hover:text-orchid-400"
                          />
                          <span className="flex-1">{item.title}</span>
                          <svg
                            className={classNames(
          ...
          <div className="flex-shrink-0 flex bg-orchid-900 p-4">
